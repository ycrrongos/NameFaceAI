...
export function CameraView({
  ...
  }, [showOverlay, mirrored, active, frameReady, frameSize, useStream, sourceFrameSize?.width, sourceFrameSize?.height]);
        ...
        <Box sx={{ position: "relative", bgcolor: "#1a1a2e", aspectRatio: "16 / 9", maxHeight: 480 }}>
          ...
          {showOverlay && (
            <Box
              component="canvas"
              ref={canvasRef}
              sx={{ position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none", zIndex: 2 }}
            />
          )}
          {showStartButton && (
            <Box
